...
@Component({
  selector: 'app-assignedmalfunctions',
  templateUrl: './assignedmalfunctions.page.html',
  styleUrls: ['./assignedmalfunctions.page.scss'],
})
export class AssignedmalfunctionsPage implements OnInit {
